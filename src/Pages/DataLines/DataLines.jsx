        ...
        <div>
            <Grid container>
                                ...
                                <Grid container direction="column" sx={{ justifyContent: 'center', alignItems: 'center' }}>
                                    <Grid size={{ xs: 12, md: 12 }}>
                                        <FormControl sx={{ m: 1, minWidth: 205 }}>
                                            <InputLabel id="input" htmlFor="input-select">Choose Input</InputLabel>
                                            <Select 
                                    ...
                                    <Grid size={{ xs: 12, md: 12 }} sx={ { m: 1, minWidth: 205 } }>
                                        <TextField
                                            id="interval"
                                            label="Interval (Days)"
                                            value={interval}
                ...
                <Grid size={{ xs: 12, md: 12 }}>
                    <Paper sx={ paperStyle }>
                        <Grid container>
                            <Grid size={{ md: 12 }}>{'Maya Long Counts in ' + interval + ' day intervals, ' + handleHeader() + ', using correlation factor ' + correlation  }</Grid>
                            <Grid size={{ md: 12 }}>{'NOTE: A maximum of 200 lines can be shown; adjust start/end date and interval accordingly to find the window of data you want'}</Grid>
                        </Grid>
                    </Paper>
                </Grid>
