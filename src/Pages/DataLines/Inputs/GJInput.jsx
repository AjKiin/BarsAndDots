...
export default function GJInput(props) {
    ...
    return(
        ...
        <Grid container sx={{ justifyContent: "center" }}>
            ...
            <Grid size={{ xs: 12, md: 2 }} sx={{ marginTop: '25px', marginBottom: '10px' }}>
                Start:
            </Grid>

            <Grid size={{ xs: 12, md: 3 }}>
            <FormControl sx={{ m: 1, minWidth: 150 }}>
                <InputLabel id="GJ1" htmlFor="gj1-select">Select Calendar</InputLabel>
                <Select
                    inputProps={{ id: 'gj1-select' }}
                    value={type}
            ...
            <Grid size={{ xs: 4, md: 2 }} sx={textboxStyle}>
                <TextField
                    ...
                    inputprops={{ min: -4800, max: 4800 }}
                />
            </Grid>
            <Grid size={{ xs: 3, md: 2 }} sx={textboxStyle}>
                <TextField
                    id="month"
                    label="Month"
                    value={month}
            ...
            <Grid size={{ xs: 12, md: 2}} sx={{ marginTop: '25px', marginBottom: '10px' }}>End:</Grid>

            <Grid size={{ xs: 12, md: 3 }}>
            <FormControl sx={{ m: 1, minWidth: 150 }}>
                <InputLabel id="GJ2" htmlFor="gj2-select">Select Calendar</InputLabel>
                <Select
                    inputProps={{ id: 'gj2-select' }}
                    value={type2}
