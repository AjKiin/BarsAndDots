...
export default function LongCountInput(props) {
    ...
    return(
        ...
        <Grid container sx={{ alignItems: "center" }}>
            ...
            <Grid size={{ xs: 4, md: 2 }} sx={textboxStyle}>
                <FormControl sx={{ m: 1, minWidth: 100 }}>
                    <InputLabel id="endPiktun" htmlFor="endpiktun-select">End Piktuns</InputLabel>
                    <Select 
                        inputProps={{ id: 'endpiktun-select' }}
                        value={endPiktuns} 
            ...
            <Grid size={{ xs: 4, md: 2 }} sx={textboxStyle}>
                <FormControl sx={{ m: 1, minWidth: 100 }}>
                    <InputLabel id="endBaktun" htmlFor="endbaktun-select">End Baktuns</InputLabel>
                    <Select 
                        inputProps={{ id: 'endbaktun-select' }}
                        value={endBaktuns} 
            ...
            <Grid size={{ xs: 4, md: 2 }} sx={textboxStyle}>
                <FormControl sx={{ m: 1, minWidth: 100 }}>
                    <InputLabel id="endKatun" htmlFor="endkatun-select">End Katuns</InputLabel>
                    <Select 
                        inputProps={{ id: 'endkatun-select' }}
                        value={endKatuns} 
            ...
            <Grid size={{ xs: 4, md: 2 }} sx={textboxStyle}>
                <FormControl sx={{ m: 1, minWidth: 100 }}>
                    <InputLabel id="endTun" htmlFor="endtun-select">End Tuns</InputLabel>
                    <Select 
                        inputProps={{ id: 'endtun-select' }}
                        value={endTuns} 
            ...
            <Grid size={{ xs: 4, md: 2 }} sx={textboxStyle}>
                <FormControl sx={{ m: 1, minWidth: 100 }}>
                    <InputLabel id="endWinal" htmlFor="endwinal-select">End Winals</InputLabel>
                    <Select 
                        inputProps={{ id: 'endwinal-select' }}
                        value={endWinals} 
            ...
            <Grid size={{ xs: 4, md: 2 }} sx={textboxStyle}>
                <FormControl sx={{ m: 1, minWidth: 100 }}>
                    <InputLabel id="endKin" htmlFor="endkin-select">End Kins</InputLabel>
                    <Select     
                        inputProps={{ id: 'endkin-select' }}
                        value={endKins} 
