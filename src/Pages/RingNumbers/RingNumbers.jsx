        ...
        <Grid container>
            ...
            <Grid size={{ xs: 12, md: 6 }}>
                <Paper sx={ paperStyleInput }>
                    <Grid container>
                        <Grid size={{ xs: 12 }}><p>Long Count Companion Number</p></Grid>
                        <Grid size={{ xs: 12 }}>
            ...
            <Grid size={{ xs: 12, md: 6 }}>
                <Paper sx={ paperStyleInput }>
                    <Grid container>
                        <Grid size={{ xs: 12 }}><p>Associated Ring Number</p></Grid>
                        <Grid size={{ xs: 12 }}>
                            <Grid container sx={{ justifyContent: "center" }}>
                                ...
                                <Grid size={{ xs: 4, md: 2 }} sx={textboxStyle}>
                                    <FormControl sx={{ m: 1, minWidth: 100 }}>
                                        <InputLabel id="piktun2" htmlFor="piktun2-select">Piktuns</InputLabel>
                                        <Select 
                                            inputProps={{ id: 'piktun2-select' }}
                                            value={piktuns2} 
                                ...
                                <Grid size={{ xs: 4, md: 2 }} sx={textboxStyle}>
                                    <FormControl sx={{ m: 1, minWidth: 100 }}>
                                        <InputLabel id="baktun2" htmlFor="baktun2-select">Baktuns</InputLabel>
                                        <Select 
                                            inputProps={{ id: 'baktun2-select' }}
                                            value={baktuns2} 
                                ...
                                <Grid size={{ xs: 4, md: 2 }} sx={textboxStyle}>
                                    <FormControl sx={{ m: 1, minWidth: 100 }}>
                                        <InputLabel id="katun2" htmlFor="katun2-select">Katuns</InputLabel>
                                        <Select 
                                            inputProps={{ id: 'katun2-select' }}
                                            value={katuns2} 
                                ...
                                <Grid size={{ xs: 4, md: 2 }} sx={textboxStyle}>
                                    <FormControl sx={{ m: 1, minWidth: 100 }}>
                                        <InputLabel id="tun2" htmlFor="tun2-select">Tuns</InputLabel>
                                        <Select 
                                            inputProps={{ id: 'tun2-select' }}
                                            value={tuns2} 
                                ...
                                <Grid size={{ xs: 4, md: 2 }} sx={textboxStyle}>
                                    <FormControl sx={{ m: 1, minWidth: 100 }}>
                                        <InputLabel id="winal2" htmlFor="winal2-select">Winals</InputLabel>
                                        <Select 
                                            inputProps={{ id: 'winal2-select' }}
                                            value={winals2} 
                                ...
                                <Grid size={{ xs: 4, md: 2 }} sx={textboxStyle}>
                                    <FormControl sx={{ m: 1, minWidth: 100 }}>
                                        <InputLabel id="kin2" htmlFor="kin2-select">Kins</InputLabel>
                                        <Select 
                                            inputProps={{ id: 'kin2-select' }}
                                            value={kins2} 
