...
import LCPop from './Inputs/LCPop';
                        ...
                        <Grid container sx={{ alignItems: "center", justifyContent: "center" }}>
                            <Grid size={{ xs: 12, md: 12 }}>
                                <FormControl sx={{ m: 1, minWidth: 150 }}>
                                    <InputLabel id="age-simple" htmlFor="input-select">Choose Input</InputLabel>
                                    <Select
                                        inputProps={{ id: 'input-select' }}
                                        value={selectedInput}
                            ...
                            <Grid size={{ xs: 12, md: 12 }}>{inputContent()}</Grid>
                        </Grid>
                    </Paper>
                </Grid>
                ...
                <Grid style={{width: '330px'}}>
                    <Paper sx={ paperStela }>
                        <Grid container>
                            ...
                            <Grid size={{ xs: 8, md: 8 }}><BootstrapTooltip title={toolTipMessages[0]}><img src={ISIGGlyphPaths[ cr.haabName ]} alt="glyph" /></BootstrapTooltip></Grid>
                            ...
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[30]}><img src={LCGlyphPaths[6]} alt="glyph" /></BootstrapTooltip></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><img src={numberGlyphPaths[lc.piktuns]} alt="glyph" /></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[29]}><img src={LCGlyphPaths[5]} alt="glyph" /></BootstrapTooltip></Grid>


                            <Grid size={{ xs: 4, md: 4 }}>
                                <p>{lc.baktuns} Baktuns<br></br>{lc.katuns} Katuns</p>
                            </Grid>
                            <Grid size={{ xs: 2, md: 2 }}><img src={numberGlyphPaths[ lc.baktuns < 0 || lc.baktuns > 19 ? 20 : lc.baktuns ]} alt="glyph" /></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[1]}><img src={LCGlyphPaths[4]} alt="glyph" /></BootstrapTooltip></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><img src={numberGlyphPaths[lc.katuns]} alt="glyph" /></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[2]}><img src={LCGlyphPaths[3]} alt="glyph" /></BootstrapTooltip></Grid>

                            <Grid size={{ xs: 4, md: 4 }}>
                                <p>{lc.tuns} Tuns<br></br>{lc.winals} Winals</p>
                            </Grid>
                            <Grid size={{ xs: 2, md: 2 }}><img src={numberGlyphPaths[lc.tuns]} alt="glyph" /></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[3]}><img src={LCGlyphPaths[2]} alt="glyph" /></BootstrapTooltip></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><img src={numberGlyphPaths[lc.winals]} alt="glyph" /></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[4]}><img src={LCGlyphPaths[1]} alt="glyph" /></BootstrapTooltip></Grid>

                            <Grid size={{ xs: 4, md: 4 }}>
                                <p>{lc.kins} Kins<br></br>Tzolkin: {TZOLKIN_COEFFICIENTS[cr.tzolkinCoefficient]} {TZOLKIN_NAMES[cr.tzolkinName][names]}</p>
                            </Grid>
                            <Grid size={{ xs: 2, md: 2 }}><img src={numberGlyphPaths[lc.kins]} alt="glyph" /></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[5]}><img src={LCGlyphPaths[0]} alt="glyph" /></BootstrapTooltip></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><img src={numberGlyphPaths[TZOLKIN_COEFFICIENTS[cr.tzolkinCoefficient]]} alt="glyph" /></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[6]}><img src={tzolkinGlyphPaths[cr.tzolkinName]} alt="glyph" /></BootstrapTooltip></Grid>

                            <Grid size={{ xs: 4, md: 4 }}>
                                <p>Lord of the Night: {god}<br></br>Glyph F</p>
                            </Grid>
                            <Grid size={{ xs: 2, md: 2 }}></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[7]}><img src={lordsGlyphPaths[god-1]} alt="glyph" /></BootstrapTooltip></Grid>
                            <Grid size={{ xs: 2, md: 2 }}></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[8]}><img src={letteredGlyphPaths[0]} alt="glyph" /></BootstrapTooltip></Grid>
                            ...
                            <Grid size={{ xs: 2, md: 2 }}><img src={numberGlyphPaths[lunarInfo.D]} alt="glyph" /></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[9]}><img src={letteredGlyphPaths[1]} alt="glyph" /></BootstrapTooltip></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><img src={numberGlyphPaths[lunarInfo.E]} alt="glyph" /></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[10]}><img src={letteredGlyphPaths[2]} alt="glyph" /></BootstrapTooltip></Grid>

                            <Grid size={{ xs: 4, md: 4 }}>
                                <p>Glyph C - {lunarInfo.C}<br></br>X - Lunar month</p>
                            </Grid>
                            <Grid size={{ xs: 2, md: 2 }}><img src={numberGlyphPaths[lunarInfo.C]} alt="glyph" /></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[11]}><img src={letteredGlyphPaths[3]} alt="glyph" /></BootstrapTooltip></Grid>
                            <Grid size={{ xs: 2, md: 2 }}></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[12]}><img src={letteredGlyphPaths[ lunarInfo.C + 8 ]} alt="glyph" /></BootstrapTooltip></Grid>

                            <Grid size={{ xs: 4, md: 4 }}>
                                <p>B - "was its name"<br></br>A - {getMonthSize(moonAge) + 29} day month</p>
                            </Grid>
                            <Grid size={{ xs: 2, md: 2 }}></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[13]}><img src={letteredGlyphPaths[5]} alt="glyph" /></BootstrapTooltip></Grid>
                            <Grid size={{ xs: 2, md: 2 }}></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[14]}><img src={letteredGlyphPaths[ getMonthSize(moonAge) + 6 ]} alt="glyph" /></BootstrapTooltip></Grid>

                            <Grid size={{ xs: 4, md: 4 }}>
                                <p>Glyph YZ - {lunarInfo.Y}<br></br>
                                Haab: {cr.haabCoefficient === 0 ? 'Seating of ' : cr.haabCoefficient} {HAAB_NAMES[cr.haabName][names]}</p>
                            </Grid>
                            <Grid size={{ xs: 2, md: 2 }}><img src={numberGlyphPaths[lunarInfo.Y]} alt="glyph" /></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[15]}><img src={letteredGlyphPaths[4]} alt="glyph" /></BootstrapTooltip></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><img src={numberGlyphPaths[cr.haabCoefficient]} alt="glyph" /></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[16]}><img src={haabGlyphPaths[cr.haabName]} alt="glyph" /></BootstrapTooltip></Grid>
                            ...
                            <Grid size={{ xs: 2, md: 2 }}></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[17]}><img src={variousGlyphPaths[2]} alt="glyph" /></BootstrapTooltip></Grid>
                            <Grid size={{ xs: 2, md: 2 }}></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[18]}><img src={variousGlyphPaths[3]} alt="glyph" /></BootstrapTooltip></Grid>

                            <Grid size={{ xs: 4, md: 4 }}>
                                <p>{diffLC.tuns} Tun<br></br>{diffLC.winals} Winal</p>
                            </Grid>
                            <Grid size={{ xs: 2, md: 2 }}><img src={numberGlyphPaths[ diffLC.tuns ]} alt="glyph" /></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[19]}><img src={LCGlyphPaths[2]} alt="glyph" /></BootstrapTooltip></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><img src={numberGlyphPaths[ diffLC.winals ]} alt="glyph" /></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[20]}><img src={LCGlyphPaths[1]} alt="glyph" /></BootstrapTooltip></Grid>
                            ...
                            <Grid size={{ xs: 2, md: 2 }}><img src={numberGlyphPaths[ diffLC.kins ]} alt="glyph" /></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[21]}><img src={LCGlyphPaths[0]} alt="glyph" /></BootstrapTooltip></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><img src={numberGlyphPaths[ TZOLKIN_COEFFICIENTS[lcdToCRInfo(station).tzolkinCoefficient] ]} alt="glyph" /></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[22]}><img src={tzolkinGlyphPaths[ lcdToCRInfo(station).tzolkinName ]} alt="glyph" /></BootstrapTooltip></Grid>
                            ...
                            <Grid size={{ xs: 2, md: 2 }}><img src={numberGlyphPaths[lcdToCRInfo(station).haabCoefficient]} alt="glyph" /></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[23]}><img src={haabGlyphPaths[ lcdToCRInfo(station).haabName ]} alt="glyph" /></BootstrapTooltip></Grid>
                            <Grid size={{ xs: 2, md: 2 }}></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[24]}><img src={variousGlyphPaths[0]} alt="glyph" /></BootstrapTooltip></Grid>
                            ...
                            <Grid size={{ xs: 2, md: 2 }}></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[25]}><img src={directionGlyphPaths[ getDirectionColorIndex(lcdToCRInfo(station).tzolkinName) ]} alt="glyph" /></BootstrapTooltip></Grid>
                            <Grid size={{ xs: 2, md: 2 }}></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[26]}><img src={colorGlyphPaths[ getDirectionColorIndex(lcdToCRInfo(station).tzolkinName) ]} alt="glyph" /></BootstrapTooltip></Grid>

                            <Grid size={{ xs: 4, md: 4 }}>
                                <p>K'awil god<br></br>Unknown glyph</p> 
                            </Grid>
                            <Grid size={{ xs: 2, md: 2 }}></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[27]}><img src={variousGlyphPaths[1]} alt="glyph" /></BootstrapTooltip></Grid>
                            <Grid size={{ xs: 2, md: 2 }}></Grid>
                            <Grid size={{ xs: 2, md: 2 }}><BootstrapTooltip title={toolTipMessages[28]}><img src={variousGlyphPaths[4]} alt="glyph" /></BootstrapTooltip></Grid>
