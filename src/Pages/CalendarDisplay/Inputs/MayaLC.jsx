...
export default function MayaLC(props) {
    ...
    return(
        ...
        <Grid container>
            ...
            <Grid size={{ xs: 6, md: 6 }} sx={textboxStyleRight}></Grid>
            <Grid size={{ xs: 6, md: 6 }} sx={textboxStyleLeft}>
            ...
            <Grid size={{ xs: 6, md: 6 }} sx={textboxStyleRight}>
                <FormControl sx={{ m: 1, minWidth: 100 }}>
            ...
            <Grid size={{ xs: 6, md: 6 }} sx={textboxStyleLeft}></Grid>
