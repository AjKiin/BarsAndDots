...
export default function LCPop (props) {
    ...
    return(
        ...
        <Grid container sx={{ justifyContent: "center" }}>
            ...
            <Grid size={{ md: 6 }} sx={textboxStyleRight}></Grid>

            <Grid size={{ xs: 4, md: 6 }} sx={textboxStyleLeft}>
            ...
            <Grid size={{ xs: 4, md: 6 }} sx={textboxStyleRight}>
                <FormControl sx={{ m: 1, minWidth: 100 }}>
            ...
            <Grid size={{ md: 6 }} sx={textboxStyleLeft}></Grid>
