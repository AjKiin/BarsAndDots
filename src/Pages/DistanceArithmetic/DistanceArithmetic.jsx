    ...
    function changeValue(changeFlag) {
        ...
        switch(selectedInput) {
            ...
            case 'dataJDN':
                ...
                let newJDN = changeFlag > 0 ? Number(lastJDN) + Number(changeJDN) : Number(lastJDN) - Number(changeJDN);

                // Find the LCD of the resulting date post-operation
            ...
            case 'dataJDNLC':
                ...
                // Find the new JDN post-change
                let newJDNLC = changeFlag > 0 ? Number(lastJDNLC) + Number(changeJDNLC) : Number(lastJDNLC) - Number(changeJDNLC);

                // Find the JDN for the new date post-operation
    ...
    return(
        ...
        <div>
            <Grid container sx={{ justifyContent: 'space-evenly' }}>
                        ...
                        <Grid container sx={{ alignItems: 'center' }}>
                            <Grid size={{ xs: 12, md: 4}}>
                                <FormControl sx={{ m: 1, minWidth: 150 }}>
                                    <InputLabel id="choose" htmlFor="input-select">Choose Input</InputLabel>
                                    <Select 
                ...
                <Grid size={{ xs: 12, md: 12}}><p></p></Grid>
                <Grid size={{ xs: 12, md: 12}}>
                    <Grid container>
