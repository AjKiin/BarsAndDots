        ...
        <Grid container>
            <Grid size={{ md: 9 }}>
                ...
                <Grid container>
                    ...
                    <Grid size={{ xs: 12, md: 3 }}>
                        <FormControl sx={{ m: 1, minWidth: 150 }}>
                            <InputLabel id="TN1" htmlFor="crd-tnum1-select">1st Tzolk'in Number</InputLabel>
                            <Select 
                                inputProps={{ id: 'crd-tnum1-select' }}
                    ...
                    <Grid size={{ xs: 12, md: 3 }}>
                        <FormControl sx={{ m: 1, minWidth: 150 }}>
                            <InputLabel id="TM1" htmlFor="crd-tname1-select">1st Tzolk'in Name</InputLabel>
                            <Select 
                                inputProps={{ id: 'crd-tname1-select' }}
                                value={tzolkinName} 
                    ...
                    <Grid size={{ xs: 12, md: 3 }}>
                        <FormControl sx={{ m: 1, minWidth: 150 }}>
                            <InputLabel id="HD1" htmlFor="crd-hd1-select">1st Haab Day</InputLabel>
                            <Select 
                                inputProps={{ id: 'crd-hd1-select' }}
                    ...
                    <Grid size={{ xs: 12, md: 3 }}>
                        <FormControl sx={{ m: 1, minWidth: 150 }}>
                            <InputLabel id="HM1" htmlFor="crd-hm1-select">1st Haab Month</InputLabel>
                            <Select 
                                inputProps={{ id: 'crd-hm1-select' }}
                                value={haabName} 
                ...
                <Grid container>
                    <Grid size={{ xs: 12, md: 3 }}>
                        <FormControl sx={{ m: 1, minWidth: 150 }}>
                            <InputLabel id="TN2" htmlFor="crd-tnum2-select">2nd Tzolk'in Number</InputLabel>
                            <Select 
                                inputProps={{ id: 'crd-tnum2-select' }}
                    ...
                    <Grid size={{ xs: 12, md: 3 }}>
                        <FormControl sx={{ m: 1, minWidth: 150 }}>
                            <InputLabel id="TM2" htmlFor="crd-tname2-select">2nd Tzolk'in Name</InputLabel>
                            <Select 
                                inputProps={{ id: 'crd-tname2-select' }}
                                value={tzolkinName2} 
                    ...
                    <Grid size={{ xs: 12, md: 3 }}>
                        <FormControl sx={{ m: 1, minWidth: 150 }}>
                            <InputLabel id="HD2" htmlFor="crd-hd2-select">2nd Haab Day</InputLabel>
                            <Select 
                                inputProps={{ id: 'crd-hd2-select' }}
                    ...
                    <Grid size={{ xs: 12, md: 3 }}>
                        <FormControl sx={{ m: 1, minWidth: 150 }}>
                            <InputLabel id="HM2" htmlFor="crd-hm2-select">2nd Haab Month</InputLabel>
                            <Select 
                                inputProps={{ id: 'crd-hm2-select' }}
                                value={haabName2} 
