                ...
                <Grid container>
                    <Grid size={{ xs: 12, md: 3 }}>
                        <FormControl sx={{ m: 1, minWidth: 150 }}>
                            <InputLabel id="HD" htmlFor="hp-hd-select">Haab Day</InputLabel>
                            <Select 
                                inputProps={{ id: 'hp-hd-select' }}
                    ...
                    <Grid size={{ xs: 12, md: 3 }}>
                        <FormControl sx={{ m: 1, minWidth: 150 }}>
                            <InputLabel id="HM" htmlFor="hp-hm-select">Haab Month</InputLabel>
                            <Select 
                                inputProps={{ id: 'hp-hm-select' }}
                                value={haabName} 
