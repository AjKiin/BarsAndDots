                ...
                <Grid container>
                    <Grid size={{ xs: 12, md: 3 }}>
                        <FormControl sx={{ m: 1, minWidth: 150 }}>
                            <InputLabel id="TN" htmlFor="tp-tnum-select">Tzolk'in Number</InputLabel>
                            <Select 
                                inputProps={{ id: 'tp-tnum-select' }}
                    ...
                    <Grid size={{ xs: 12, md: 3 }}>
                        <FormControl sx={{ m: 1, minWidth: 150 }}>
                            <InputLabel id="TM" htmlFor="tp-tname-select">Tzolk'in Name</InputLabel>
                            <Select 
                                inputProps={{ id: 'tp-tname-select' }}
                                value={tzolkinName} 
