            ...
            <Grid size={{ md: 9 }}>
                ...
                <Grid container>
                    ...
                    <FormControl sx={{ m: 1, minWidth: 150 }}>
                            <InputLabel id="HD1" htmlFor="hd-hd1-select">1st Haab Day</InputLabel>
                            <Select 
                                inputProps={{ id: 'hd-hd1-select' }}
                    ...
                    <Grid size={{ xs: 12, md: 3 }}>
                        <FormControl sx={{ m: 1, minWidth: 150 }}>
                            <InputLabel id="HM1" htmlFor="hd-hm1-select">1st Haab Month</InputLabel>
                            <Select 
                                inputProps={{ id: 'hd-hm1-select' }}
                                value={haabName} 
                    ...
                    <Grid size={{ xs: 12, md: 3 }}>
                        <FormControl sx={{ m: 1, minWidth: 150 }}>
                            <InputLabel id="HD2" htmlFor="hd-hd2-select">2nd Haab Day</InputLabel>
                            <Select 
                                inputProps={{ id: 'hd-hd2-select' }}
                    ...
                    <Grid size={{ xs: 12, md: 3 }}>
                        <FormControl sx={{ m: 1, minWidth: 150 }}>
                            <InputLabel id="HM2" htmlFor="hd-hm2-select">2nd Haab Month</InputLabel>
                            <Select 
                                inputProps={{ id: 'hd-hm2-select' }}
                                value={haabName2} 
