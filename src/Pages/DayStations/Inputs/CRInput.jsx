...
export default function CRInput(props) {
    ...
    return(
        ...
        <Grid container>
            ...
            <Grid size={{ md: 2 }}></Grid>
            <Grid size={{ xs: 12, md: 2 }} sx={textboxStyle}>
                <FormControl sx={{ m: 1, minWidth: 150 }}>
                    <InputLabel id="TN" htmlFor="tzolkin-day">Tzolk'in Day Number</InputLabel>
                    <Select 
                        inputProps={{ id: 'tzolkin-day' }}
            ...
            <Grid size={{ xs: 12, md: 2 }} sx={textboxStyle}>
                <FormControl sx={{ m: 1, minWidth: 150 }}>
                    <InputLabel id="TD" htmlFor="tzolkin-name">Tzolk'in Day Name</InputLabel>
                    <Select 
                        inputProps={{ id: 'tzolkin-name' }}
                        value={tzolkinName} 
            ...
            <Grid size={{ xs: 12, md: 2 }} sx={textboxStyle}>
                <FormControl sx={{ m: 1, minWidth: 150 }}>
                    <InputLabel id="HD" htmlFor="haab-day">Haab Day</InputLabel>
                    <Select 
                        inputProps={{ id: 'haab-day' }}
            ...
            <Grid size={{ xs: 12, md: 2 }} sx={textboxStyle}>
                <FormControl sx={{ m: 1, minWidth: 150 }}>
                    <InputLabel id="HM" htmlFor="haab-month">Haab Month</InputLabel>
                    <Select 
                        inputProps={{ id: 'haab-month' }}
                        value={haabName} 
