        ...
        <div>
            <Grid container>
                ...
                <Grid size={{ xs: 12 }}>
                    <Paper sx={ paperStyle }>
                        <Grid container>
                            <Grid size={{ xs: 12, md: 2 }}>{'Input Initial Series'}</Grid>
                            <Grid size={{ xs: 12, md: 10 }}>{inputContent()}</Grid>
                        </Grid>
                    </Paper>
                </Grid>
                ...
                <Grid size={{ xs: 12 }}>
                    <Paper sx={ paperStyle }>
                        <Grid container>
                            <Grid size={{ xs: 12 }}>Searching using the above criteria...</Grid>
                            <Grid size={{ xs: 12 }}><b>{handleHeader()}</b></Grid>
                            <Grid size={{ xs: 12 }}>{'Using correlation factor: ' + correlation }</Grid>
                            <Grid size={{ xs: 12 }}>{'NOTE: If the resulting set has more than 10,000 lines, only the first 10,000 will be shown'}</Grid>
                        </Grid>
                    </Paper>
                </Grid>
